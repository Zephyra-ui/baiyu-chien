  ...
  const characterData = {
    chien: {
      ...
      ability: [
        ...
        '对蔷薇培育与花艺有独到心得，打理花房是少有的放松方式',
        '观察力敏锐，能轻易洞察局势与人心，处事果决不拖泥带水'
      ],
      quote: '"蔷薇有刺，方能护得自身周全。你若懂它，便知温柔只给意中人。"'
    },
    baiyu: {
      theme: 'baiyu-theme',
...
const worldData = {
  ...
  "希恩家族": "杜塞尔公国的统治皇室，以蔷薇纹章为家族核心标识。家族旁支宗室可受封边境领地并世袭统治，其中旁支成员安妮可・希恩（池恩）为当今皇帝的亲侄女，是南部边境领地的第十六代世袭领主，十岁丧父，十五岁正式继位守边。",
  "银蔷薇军团": "杜塞尔公国的核心边防军事力量，成立于三百年前，以银蔷薇为军团象征，寓意坚韧与温柔。军团世代驻守公国边境，是国家防御体系的重要支柱，与南部边境符阵共同构成国境防护屏障。",
  "中州符术师使团": "来自东方中州的官方外交与技术团队，拥有体系成熟的符术传承。受杜塞尔公国官方邀请派驻南部边境，专职负责边防符阵的巡检、维护与修复；使团内的符术师为公国官方认可的技术型客卿，享有对应待遇与边境事务参与权。",

  "杜塞尔公国皇宫": "位于公国都城的最高权力与礼仪中心，主体为象牙白石墙搭配鎏金穹顶，穹顶镶嵌七颗红宝石排列成蔷薇造型，宫外引北方雪山融水修建有人工湖。内部设有皇室肖像陈列厅、藏书房、兵器陈列室，是接见外邦使团、举办王室盛典的核心场所。",
  "蔷园": "坐落于南部边境山谷中的世袭领主庄园，是南部边境的最高治所，兼具理政、居住、军事调度三重功能。宅邸为石砌建筑，外墙与庭院遍布蔷薇藤蔓，内设政务书房、玻璃花房与演武场地，整体风格务实雅致，无过度奢华的装饰。",
  "南部边境线": "杜塞尔公国南部的国境防御带，地貌以缓坡丘陵、溪流林地为主，植被丰茂，野生蔷薇分布广泛。全线布设有超凡符阵防御体系，划分多处哨所与符文节点，其中东南段防御最为薄弱，是边境冲突的高风险区域。",

  "蔷薇祭": "公国一年一度的全民传统节日，于每年蔷薇盛放的时节举办。节日期间满城民众都会佩戴蔷薇花冠，聚集在花田间饮酒诵诗；各地公爵府会对外开放私家花园，接待民众入内参观，是融合花艺、诗歌与民俗的盛大庆典。",
  "蔷薇崇拜": "蔷薇是杜塞尔公国的国家符号与皇室家族象征，广泛应用于皇室纹章、服饰、建筑、器物的装饰纹样中。蔷薇元素深度融入官方礼制与日常审美。",
  "饮食特色": "蜂蜜糕是公国最具代表性的传统点心，以当地野花蜂蜜为原料制作，口感甜而不腻，是民间与贵族阶层都广为喜爱的日常吃食。",
  "贵族风尚": "杜塞尔公国贵族礼仪规范森严，正式场合有着严格的着装与行为礼制。贵族子弟普遍接受政务、剑术双重教育，边境贵族更需同时具备军事指挥能力与领地治理能力，贵族女性可正常承袭爵位与执掌权力。",
  "符术传统": "源自东方中州的超凡技术传统，以符笔、特制墨锭、符纸为核心载体，既可以制作单体护身符纸，也能够搭建大型防御符阵。符术修习极为考验指尖控制力与专注力，需常年练习以保证符文绘制的精准度。",

  "开国传说": "相传杜塞尔公国初代皇帝手持长剑，在边境线上亲手种下第一株蔷薇，以此划定国境、奠定公国基业。这段事迹被绘制在皇宫门廊的壁画之上，是公国家喻户晓的开国叙事。",
  "银蔷薇军团起源": "三百年前，初代军团统帅选定银蔷薇作为军团标识，赋予其 “坚韧与温柔” 的精神内核。军团自此世代传承，驻守边境至今，成为公国历史中守护国境的标志性精神符号。",
  "边境领主传承": "南部边境领地为希恩家族旁支的世袭封地，传承至第十六代时，领主之位由年仅十五岁的安妮可·希恩（池恩）承袭。她少年继位镇守边境，肖像被列入皇室成员陈列厅，是公国近代颇具传奇色彩的少龄领主。"
};
